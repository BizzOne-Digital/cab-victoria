...
const svcs = [
  ...
  {title:'Victoria City Tours',tagline:'Specialist in personalized Victoria tours — day or night.',img:'https://images.unsplash.com/photo-1775740738694-1d590125a704?q=80',points:['1 hour Express tour','Victoria City Highlights 2 hours','Grand City Tour 3 hours','Victoria Garden Tour 4 hours','Full day Tour','1 to 20 passengers'],note:'See the Tours page to preview every stop with day & night images.',href:'/tours'},
  ...
  {title:'Cowichan Valley Wine / Cider / Distillery & Craft Spirits Tour',tagline:'4–6 hours. Discover the best of Cowichan Valley.',img:'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=900&q=80',points:['Wine, cider, distillery and craft spirits tastings','Scenic drive through Cowichan Valley','Visit award-winning estates and hidden gems','Flexible 4–6 hour itinerary','1 to 20 passengers'],note:'Let Jay plan the perfect tasting route for your group.',href:null},
  {title:'Malahat Skywalk & Castle Tour',tagline:'4–5 hours. Walk above the treetops and visit a castle.',img:'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=900&q=80',points:['Breathtaking spiral tower with panoramic views','Walk through ancient Douglas Fir canopy','Castle visit included in the tour','Scenic drive along the Malahat','Can be combined with wine tour or city tour'],note:'Popular experience — book ahead for the best times.',href:null},
